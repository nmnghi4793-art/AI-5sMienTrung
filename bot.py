...
# ===================== SIMPLE BANKS (final, enforced) =====================
SIMPLE_BANKS_VERSION = "simple-banks-v5-2025-08-17"
...
# Alias để toàn bộ code cũ gọi tên nào cũng dùng hàm mới
...
print("[BOOT]", SIMPLE_BANKS_VERSION, "- simple banks enforced")
# ===================== END SIMPLE BANKS =====================
